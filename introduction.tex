...
However, this study was done for a static fuel cycle, where the
material flow and reactor deployment are at equilibrium.
Therefore the study did not take into account the dynamic
changes in fuel demand and reactor deployment as well as the
previously existing fleet. Thus, for a more comprehensive
and realistic
evaluation of a fuel cycle, fuel cycle analyses
must include the transition from a previous fleet to
the intended fuel cycle.
...
tool, \Cyclus. The added capabilities in this work will
allow \Cyclus to model \gls{NFC} transition scenarios.
...
categorize each feature into three tiers - basic, integral,
and exemplary. Basic features are essential in modeling a fuel
...
transition scenarios. Examples of integral features are
demand-driven deployment of fuel cycle facilities and
material prioritization.
Finally, Exemplary features enable exploration
of various sensitivities and technology choices, and are
not essential. Exemplary features include discrete isotope
...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{lXl}
        ...
        \hline
        \multirow{6}{*}{\shortstack{Composition \\ Features}} & Modeling of implicit consideration of fuel materials including primary fissile and fertile actinide isotopes & Basic \\
