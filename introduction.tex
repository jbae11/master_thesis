...
cycle transition scenarios, which is governed by whether
...
Since fuel cycles involve multiple facilities at play,
analyses of transition scenarios require
deliberate and dynamic tracking of materials and facilities,
in order to calculate available nuclear material
...
reactor units as agents. Second, I developed \texttt{SaltProc\_Reactor}that models \glspl{MSR}
...
composition history inside the reactor, and $k_{eff}$ values. \texttt{SaltProc\_Reactor} then
