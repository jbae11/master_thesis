...
The parameters are chosen to acquire a reasonably accurate simulation result
...
exceed 42 ppm. The fuel salt density and power density is obtained from
...
I chose SaltProc simulation parameters so that the number of
SERPENT runs does not exceed 800. 
