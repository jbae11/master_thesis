...
\glspl{MSR} reactor designs are 


The reason for needing the liquid-fueled reactor modeling in a \gls{NFCS}
is due to the recent rise of interest in \glspl{MSR} in the United States.

\glspl{SFR},
which are considered the most prominent fast-spectrum advanced reactor, behave similarly to \glspl{LWR}
