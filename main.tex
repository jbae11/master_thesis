...
metrics in a transition scenario. For reference, the metrics
...
On the other hand, publications from MIT take a more 
reluctant stance on the need to transition into a `closed' fuel cycle.
They argue that more focus should be given to \gls{LWR} technology 
because uranium is abundant, fuel cycle infrastructure is expensive,
and that nuclear energy demand is in decline \cite{kazimi_future_2011}. Since it is an interdisciplinary study, the MIT report
