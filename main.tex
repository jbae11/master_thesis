...
\title{Demonstration of real-world fuel cycle transition capabilities in Cyclus, the agent-based fuel cycle simulator}
\author{Jin Whan Bae}
...
to analyze complex \glspl{NFC} and reactor technologies. 
...
The development of the capability is in
