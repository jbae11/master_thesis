...
\title{Demonstration of Cyclus fuel cycle transition capabilities}
\author{Jin Whan Bae}
...
\begin{abstract}
This work demonstrates Cyclus capability to model and simulate analyze
real-life fuel cycle transition scenarios. First I benchmark Cyclus to
other fuel cycle simulation tools for a general fuel cycle transition
scenario. Second I develop tools and methods necessary for modeling fuel
cycle transition scenarios for real-life scenarios. Lastly I apply the
developed tools and methods to model and simulate fuel cycle transition
scenarios for France and United States.
\end{abstract}
