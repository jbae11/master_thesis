...
\begin{table}[h]
    ...
    \begin{tabularx}{\linewidth}{bss}
        ...
        Reprocessing capacity before 2020 & 91.6 \cite{schneider_spent_2008} & $\frac{\text{\gls{MTHM}}}{month}$  \\
        Reprocessing capacity after 2020 & 183.2 & $\frac{\text{\gls{MTHM}}}{month}$\\
        \gls{LWR} \gls{MOX} fabrication throughput & 16.25 \cite{hugelmann_melox_1999} & $\frac{\text{\gls{MTHM}}}{month}$\\
        \gls{ASTRID} \gls{MOX} fabrication throughput & No limit ($\infty$) & $\frac{\text{\gls{MTHM}}}{month}$ \\
