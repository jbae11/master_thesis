...
I performed additional simulations assuming random \gls{LWR} license extensions, to decrease
the number of new reactor deployment.
...
\begin{table}[h]
    ...
    \begin{tabularx}{\linewidth}{bss}
        ...
        Reprocessed uranium usage &  Storage & -\\
