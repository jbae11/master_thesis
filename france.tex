...
\gls{UNF} from other \gls{EU} nations and used that \gls{UNF} to produce \gls{MOX} for new \glspl{SFR},
...
nearest foreseeable future. Then, using \Cyclus and the tools developed in this work, I
calculated the amount of \gls{UNF} France needs
...
\begin{table}[h]
    ...
    \begin{tabular}{lSS}
        ...
        Pu240 & 0.232 & 244.11 \\ 
        Pu241 & 0.126 & 132.58 \\ 
        Pu242 & 0.048 & 51.24 \\ \hline
        \bfseries Total & 0.935 & 983.52 \\ \hline
    \end{tabular}
...
\begin{table}[h]
    ...
    \scalebox{1}{
        \begin{tabular}{llS}
            ...
            \textbf{Average UOX Reprocessing} & MTHM/month & \bfseries 124.6 \\
            \textbf{Average Total Reprocessing} & MTHM/month & \bfseries 63.23 \\
            \textbf{Average Fuel Fabrication} & MTHM/month & \bfseries 45.32 \\
            ...
            \textbf{Total legacy UNF reprocessed} & MTHM & 52,874 \\ 
