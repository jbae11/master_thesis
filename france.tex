...
\begin{figure}[htbp!]
    \begin{center}
        \includegraphics[scale=0.6]{./images/france/power_plot.png}
    \end{center}
...
\begin{figure}[htbp!]
    \begin{center}
        \includegraphics[scale=0.6]{./images/france/sfr_deploy.png}
    \end{center}
...
\begin{figure}[htbp!]
    \begin{center}
        \includegraphics[scale=0.6]{./images/france/onesim.png}
    \end{center}
...
\begin{figure}[htbp!]
    \begin{center}
        \includegraphics[scale=0.7]{./images/france/tails.png}
    \end{center}
...
\begin{figure}[htbp!]
    \begin{center}
        \includegraphics[scale=0.7]{./images/france/total_fuel.png}
    \end{center}
...
\begin{figure}[htbp!]
    \begin{center}
            \includegraphics[scale=0.7]{./images/france/snf_discharge.png}
    \end{center}
...
\begin{figure}[htbp!]
    \begin{center}
        \includegraphics[width=0.7\textwidth]{./images/france/where_fuel.png}
    \end{center}
...
\begin{figure}[htbp!]
    \begin{center}
        \includegraphics[scale=0.7]{./images/france/pu.png}
    \end{center}
...
\subsection{Results - Parameter Sweep}
\subsection{Results - Sensitivity Study}
